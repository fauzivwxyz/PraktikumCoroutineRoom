package com.akeno.myapplication
...
import com.akeno.myapplication.catatan.Note
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ItemTouchHelper(object :
            ...
            override fun onSwiped(viewHolder: RecyclerView.ViewHolder, direction: Int) {
                ...
                Toast.makeText(baseContext, "Review dihapus!", Toast.LENGTH_SHORT).show()
            }
        }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == ADD_NOTE_REQUEST && resultCode == Activity.RESULT_OK) {
            ...
            Toast.makeText(this, "Review tidak disimpan!", Toast.LENGTH_SHORT).show()
        }
    }
}
